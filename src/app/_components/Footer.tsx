          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><FooterLink href="/review">Write a Review</FooterLink></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><FooterLink href="#">Claim Business</FooterLink></li>
                <li><FooterLink href="#">Business Login</FooterLink></li>
                <li><FooterLink href="#">Add Restaurant</FooterLink></li>
                <li><FooterLink href="#">Advertising</FooterLink></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <svg className="w-5 h-5 mr-2 mt-0.5 text-gray-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
